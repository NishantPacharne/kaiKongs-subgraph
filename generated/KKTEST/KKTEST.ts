...
export class KKTEST extends ethereum.SmartContract {
  static bind(address: Address): KKTEST {
    return new KKTEST("KKTEST", address);
  }
...
export class AirdropNFTsCall extends ethereum.Call {
  get inputs(): AirdropNFTsCall__Inputs {
    return new AirdropNFTsCall__Inputs(this);
  }

  get outputs(): AirdropNFTsCall__Outputs {
    return new AirdropNFTsCall__Outputs(this);
  }
}

export class AirdropNFTsCall__Inputs {
  _call: AirdropNFTsCall;

  constructor(call: AirdropNFTsCall) {
    this._call = call;
  }
...
export class AirdropNFTsCall__Outputs {
  _call: AirdropNFTsCall;
